...
DEFAULT_STATE = {
    ...
    "section_subtitles_enabled": True,   # show auto-generated subtitles per section
    "section_subtitles": [],             # list of subtitle strings (one per overlay)
    ...
    "assembly_debug_log": [],      # list of timestamped log lines from assembly thread
